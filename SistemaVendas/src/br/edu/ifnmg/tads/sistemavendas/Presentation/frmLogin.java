...
import br.edu.ifnmg.tads.sistemavendas.DataAcess.DAO;
import br.edu.ifnmg.tads.sistemavendas.DataAcess.LoginDAO;
...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if (logindao.Login(funcionario) > 0){
            JOptionPane.showMessageDialog(rootPane, "Login efetuado com Sucesso");
            funcionario.setCodFuncionario(logindao.Login(funcionario));
            Principal janela = new Principal(logindao.Login(funcionario));
